...
<head>
    ...
    <title><?php echo Yii::T('common', 'Dependencies') ?></title>
...
<!--                <button onclick="resize_jsmind();">adusting</button></li>-->
            ...
            <ol>
                <li><button class="sub" onclick="expand();"><?php echo Yii::T('common', 'expand node') ?></button></li>
                <li><button class="sub" onclick="collapse();"><?php echo Yii::T('common', 'collapse node') ?></button></li>
                <li><button class="sub" onclick="toggle();"><?php echo Yii::T('common', 'toggle node') ?></button></li>
                <li><button class="sub" onclick="expand_to_level2();"><?php echo Yii::T('common', 'expand to level 2') ?></button></li>
                <li><button class="sub" onclick="expand_to_level3();"><?php echo Yii::T('common', 'expand to level 3') ?></button></li>
                <li><button class="sub" onclick="expand_all();"><?php echo Yii::T('common', 'expand all') ?></button></li>
                <li><button class="sub" onclick="collapse_all();"><?php echo Yii::T('common', 'collapse all') ?></button></li>
            </ol>
            <li class="clear"><?php echo Yii::T('common', 'zoom') ?></li>
            <ol>
...
<script type="text/javascript">
    ...
    function expand(){
        ...
        if(!selected_id){prompt_info("<?php echo Yii::T('common', 'please select a node first.') ?>");return;}
