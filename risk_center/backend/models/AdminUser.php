...
class AdminUser extends ActiveRecord implements IdentityInterface {
    ...
    public static function id($uid = ''){
        return self::findOne(['id' => $uid,'open_status'=>self::OPEN_STATUS_ON]);
    }
    ...
    public static function findByPhone($phone) {
        return static::findOne(['phone' => $phone,'open_status'=>self::OPEN_STATUS_ON]);
    }
    ...
    public static function errorAndLock($user)
    {
        ...
        if($error_num > 5)
        {
            ...
            if (YII_ENV_PROD) {
                ...
                $weWorkMessage = "账户名称{$user->username},密码多次错误,账户被锁定.";
