...
class AssistDataService extends BaseService
{

    private $base_uri       = 'https://api-collection.smallflyelephantsaas.com/';
    private $getRiskDataUri = 'risk/get-risk-data';
    private $getModelScoreRiskDataUri = 'risk/get-model-score-risk-data';
     ...
     * @throws \GuzzleHttp\Exception\GuzzleException
     */
    public function getModelScoreRiskData($params)
    {
        $result = $this->postData($this->getModelScoreRiskDataUri, $params);
        return $result;
    }
