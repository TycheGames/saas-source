...
//                    RiskRules::STATUS_TEST
    ...
    public function insertRiskResultSnapshotToDb(int $orderId, int $user_id, $app_name, $treeCode,  $resultData, $version = '')
    {
        $riskResult = new RiskResultSnapshot();
        $riskResult->app_name = $app_name;
        $riskResult->order_id = $orderId;
        $riskResult->user_id = $user_id;
