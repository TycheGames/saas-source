...
public class KYCStatusBarCompatLollipop {
    /**
     ...
     */
    static void translucentStatusBar(Window window, boolean hideStatusBarBackground) {
...
//            window.setStatusBarColor(Color.TRANSPARENT);
//            window.getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR | View.SYSTEM_UI_FLAG_IMMERSIVE);
//        }
