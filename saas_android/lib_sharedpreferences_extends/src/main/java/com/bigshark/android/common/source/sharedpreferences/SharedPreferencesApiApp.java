 ...
 * temp:/*{Build.appname}*\/
 */
public class SharedPreferencesApiApp extends SharedPreferencesApiBase {
...
//    private static final String KEY_MAIN_TABS_CONTENT = /*BuildConfig.PACKAGE_NAME +*/ "main_tabs_content";// 主页tab的数据
    ...
    public String getConfigUrl() {
        return sp.getString(KEY_URL_CONFI, "http://192.168.8.101/developer/dev");
    }

    public void setConfigUrl(String devConfigUrl) {
        edit().putString(KEY_URL_CONFI, devConfigUrl).apply();
    }

    public void setWebviewUrl(String webviewUrl) {
        edit().putString(KEY_URL_WEBVIEW, webviewUrl).apply();
    }

    public String getWebviewUrl() {
        return sp.getString(KEY_URL_WEBVIEW, "");
    }
...
//        String oldMainTabContent = sp.getString(KEY_MAIN_TABS_CONTENT, null);
...
//        String mainTabContent = sp.getString(KEY_MAIN_TABS_CONTENT, null);
...
//    }
    ...
    public String getAppsflyerAfStatus() {
        return sp.getString(APPSFLYER_AF_STATUS, "");
    }

    public String getAppsflyerMediaSource() {
        return sp.getString(APPSFLYER_MEDIA_SOURCE, "");
    }

    public String getAppsflyerClickTime() {
        return sp.getString(APPSFLYER_CLICK_TIME, "");
    }

    public String getAppsflyerInstallTime() {
        return sp.getString(APPSFLYER_INSTALL_TIME, "");
    }
    ...
    public boolean isFirstIn() {
        return sp.getBoolean(KEY_FIRST_IN, true);
    }

    public void setFirstIn() {
        edit().putBoolean(KEY_FIRST_IN, false).apply();
    }
