package com.bigshark.android.widget.bar;
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                case R.styleable.CountDownProgressBar_countDown_firstColor:
                    firstColor = ta.getColor(attr, Color.WHITE); // 默认底色为白色
                    break;
                case R.styleable.CountDownProgressBar_countDown_secondColor:
                    secondColor = ta.getColor(attr, Color.YELLOW); // 默认进度条颜色为黄色
                    break;
                ...
                case R.styleable.CountDownProgressBar_countDown_centerTextColor:
                    centerTextColor = ta.getColor(attr, Color.YELLOW); // 默认中间文字颜色为蓝色
                    break;
