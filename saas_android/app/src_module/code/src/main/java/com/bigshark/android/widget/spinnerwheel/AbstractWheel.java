...
import com.bigshark.android.widget.spinnerwheel.adapters.WheelViewAdapter;
...
public abstract class AbstractWheel extends View {
    ...
    protected void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        mVisibleItems = a.getInt(R.styleable.AbstractWheelView_sw_visibleItems, DEF_VISIBLE_ITEMS);
        mIsAllVisible = a.getBoolean(R.styleable.AbstractWheelView_sw_isAllVisible, false);
        mIsCyclic = a.getBoolean(R.styleable.AbstractWheelView_sw_isCyclic, DEF_IS_CYCLIC);
