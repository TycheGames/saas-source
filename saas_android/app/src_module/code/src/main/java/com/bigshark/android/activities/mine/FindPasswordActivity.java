 ...
 * 找回密码
 */
public class FindPasswordActivity extends DisplayBaseActivity {
...
//        HttpApi.app().findPassword(this, userLoginRequestBean, new HttpCallback<String>() {
//            @Override
//            public void onSuccess(int code, String message, String data) {
//                ToastUtil.showToast(FindPasswordActivity.this, message);
//                finish();
//            }
//
//            @Override
//            public void onFailed(HttpError error) {
//                ToastUtil.showToast(FindPasswordActivity.this, error.getErrMessage());
//            }
//        });
    }
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case INTERVAL:
                    if (curTime > 0) {
                        tv_replacephone_get_code.setText("" + curTime + "s");
