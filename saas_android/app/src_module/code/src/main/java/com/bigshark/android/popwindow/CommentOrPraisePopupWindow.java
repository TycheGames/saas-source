package com.bigshark.android.popwindow;
...
import com.bigshark.android.listener.OnPraiseOrCommentClickListener;
...
public class CommentOrPraisePopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public CommentOrPraisePopupWindow(Context context) {
        ...
        this.mPopupWindowHeight = dp2px(38);
        this.mPopupWindowWidth = dp2px(190);
    ...
    public void showPopupWindow(View anchor) {
        ...
        int xOffset = location[0] - mPopupWindowWidth - dp2px(10f);
