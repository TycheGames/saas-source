package com.bigshark.android.fragments;
...
public class MainFragment extends DisplayBaseFragment {
    ...
    protected void bindViews() {
        ...
        MaiDianUploaderUtils.Builder.create(display()).setEventName(StringConstant.HOME_ENTER).build();
    ...
    protected void bindListeners() {
        ...
        main_fragment_enter_btn_TextView.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MaiDianUploaderUtils.Builder.create(display()).setEventName(EventName.HOME).build();
                JumpOperationHandler.convert(mainHomeResponseModel.getJump()).createRequest().setDisplay(display()).router();
            }
        });
    }
