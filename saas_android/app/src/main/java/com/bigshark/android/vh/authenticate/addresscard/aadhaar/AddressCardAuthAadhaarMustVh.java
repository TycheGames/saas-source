 ...
 */
public class AddressCardAuthAadhaarMustVh extends DisplayBaseVh<View, Void> {
    ...
    public AddressCardAuthAadhaarMustVh(AddressCardAuthActivity activity, MediaStoreCompat mediaStoreCompat, View root, Callback callback) {
        super(activity);
    ...
    protected void bindViews() {
        super.bindViews();
        frontRoot = findViewById(R.id.authenticate_address_aadhaar_front_root);
        frontPicImage = findViewById(R.id.authenticate_address_aadhaar_front_pic);
        frontStatusImage = findViewById(R.id.authenticate_address_aadhaar_front_status);

        backRoot = findViewById(R.id.authenticate_address_aadhaar_back_root);
        backPicImage = findViewById(R.id.authenticate_address_aadhaar_back_pic);
        backStatusImage = findViewById(R.id.authenticate_address_aadhaar_back_status);
    }
    ...
    private void pickPhoto(final boolean isFront) {
        ...
        mMediaStoreCompat.dispatchCaptureIntent(mAddressCardAuthActivity, aadhaarFile, RequestCodeType.AADHAAR_MUST);
    }


    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode != RequestCodeType.AADHAAR_MUST) {
            return false;
        }
