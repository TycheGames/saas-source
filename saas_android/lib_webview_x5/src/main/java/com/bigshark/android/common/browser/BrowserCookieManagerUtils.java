...
public class BrowserCookieManagerUtils {
    ...
    public static void setCookie(Context context, String sessionId, String uid, List<String> shareCookieDomains) {
        ...
        setCookieForX5(context, sessionId, uid, shareCookieDomains);
    }
    ...
    private static void setCookieForX5(Context context, String sessionId, String uid, List<String> shareCookieDomains) {
