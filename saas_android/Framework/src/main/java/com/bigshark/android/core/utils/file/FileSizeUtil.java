...
public class FileSizeUtil {
    ...
    public static String getAutoFileOrFilesSize(String filePath) {
        ...
        return formetFileSizeString(blockSize);
    }
     ...
     * @return
     */
    private static String formetFileSizeString(long fileS) {
        try {
//            DecimalFormat df = new DecimalFormat("#.00");
            ...
            e.printStackTrace();
            CrashReport.postCatchedException(new Throwable("NumberFormatException:" + fileS));
            return "";
        }
    }
