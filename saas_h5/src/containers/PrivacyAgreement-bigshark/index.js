...
const PrivacyAgreement = props => {
  ...
  return (
    <div className="privacy-agreement-wrpper">
      ...
      <h3>2.COLLECTION OF FINANCIAL SMS INFORMATION</h3>
      <p>We don’t collect or store your personal SMS from your inbox.</p>
      <p>
        We only collect financial SMS sent by 6-digit alphanumeric senders from
        your inbox which helps us in identifying the various accounts that you
        are holding and the cash flow patterns that you have as a user to help
        us perform a credit risk assessment which enables us to determine your
        risk profile and to provide you with the appropriate credit analysis to
        enable you to take financial facilities from the regulated financial
        entities and other service providers available on the platform.
      </p>
      <p>
        While using the app, it periodically sends the financial SMS information
        to our affiliate server and to us.
      </p>
      <h3>3.COLLECTION OF MOBILE NUMBER AND EMAIL ADDRESS</h3>
      <p>
      ...
      <h3>6.COLLECTION OF INSTALLED APPLICATIONS</h3>
      <p>
      ...
      <h3>9.COLLECTION OF OTHER NON-PERSONAL INFORMATION</h3>
      <p>
      ...
      <h3>10.COLLECTION OF DEVICE INFORMATION</h3>
      <p>
      ...
      <h3>11.USE AND DISCLOSURE OF YOUR PERSONAL AND OTHER INFORMATION</h3>
      <p>
      ...
      <h3>12.USE OF YOUR DEVICE INFORMATION</h3>
      ...
      <h3>13.DISCLOSURE TO THIRD PARTIES:</h3>
      <p>
      ...
      <h3>14.LINK TO THIRD-PARTY SDK</h3>
      <p>
      ...
      <h3>15.CHANGES IN THIS PRIVACY POLICY</h3>
      <p>
      ...
      <h3>16.ACCESSING YOUR INFORMATION / CONTACTING US</h3>
      <p>
      ...
      <h3>17.YOUR PRIVACY CONTROLS</h3>
      <p>
