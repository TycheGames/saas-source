 ...
 */
class ReminderClassSchedule extends ActiveRecord
{
    ...
    {
        return '{{%reminder_class_schedule}}';
    }
     ...
     * @return bool
     */
    public static function selectAttendance($db, $userId, $date)
    {
        $log = self::find()->where([
            'admin_id' => $userId,
            'date' => $date,
