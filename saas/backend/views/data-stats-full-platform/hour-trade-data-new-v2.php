...
$this->showsubmenu(Yii::T('common', 'Comparison of daily borrowing and repayment data(full platform)'), array(
    array(Yii::T('common', 'show'), Url::toRoute(['data-stats-full-platform/daily-trade-data']),1),
));
...
<title><?php echo Yii::T('common', 'Comparison of daily borrowing and repayment data(full platform)') ?></title>
...
<?php
        $form = ActiveForm::begin([
            'id' => 'search_form',
            'method'=>'get',
            'action' => ['data-stats-full-platform/daily-trade-data'],
...
<?php echo Yii::T('common', 'Loan display') ?>：<?= Html::dropDownList('loan_type', Html::encode(Yii::$app->getRequest()->get('loan_type', '')), ['0'=> Yii::T('common', 'Total loan amount'),'1'=>Yii::T('common', 'Total number of applicants'),'2'=>Yii::T('common', 'Total applied amount'),'3'=>Yii::T('common', 'Total Lenders'),'4'=>Yii::T('common', 'Total pass rate'),'5'=>Yii::T('common', 'Number of old applicants'),'6'=>Yii::T('common', 'Old application amount'),'7'=>Yii::T('common', 'Number of old Lenders'),'8'=>Yii::T('common', 'Old loan amount'),'9'=>Yii::T('common', 'Old passing rate'),'10'=>Yii::T('common', 'Number of new applicants'),'11'=>Yii::T('common', 'New application amount'),'12'=>Yii::T('common', 'Number of new lenders'),'13'=>Yii::T('common', 'New loan amount'),'14'=>Yii::T('common', 'New passing rate'), '15' => Yii::T('common', 'Number of orders transferred to labor'), '18'=>Yii::T('common', 'Total loan amount applied for on the same day'),'19'=>Yii::T('common', 'Number of new risk control passing'),'20'=>Yii::T('common', 'Number of old risk control passing'),'21'=>Yii::T('common', 'Total number of people passing risk control'),'22'=>Yii::T('common', 'Number of manual audit orders'),'23'=>Yii::T('common', 'Registration number')]); ?>&nbsp;
<?php echo Yii::T('common', 'Repayment display') ?>：<?= Html::dropDownList('repay_type', Html::encode(Yii::$app->getRequest()->get('repay_type', '')), ['0'=>Yii::T('common', 'Total repayment rate'),'1'=>Yii::T('common', 'Total number of repayments'),'2'=>Yii::T('common', 'Total repayment amount'),'3'=>Yii::T('common', 'Number of old repayments'),'4'=>Yii::T('common', 'Old repayment amount'),'5'=>Yii::T('common', 'Old repayment rate'),'6'=>Yii::T('common', 'Number of new repayments'),'7'=>Yii::T('common', 'New repayment amount'),'8'=>Yii::T('common', 'New repayment rate'),'9'=>Yii::T('common', 'Total number of active repayments'),'10'=>Yii::T('common', 'Number of new active repayments'),'11'=>Yii::T('common', 'Number of old active repayments')]); ?>&nbsp;
    ...
    <form name="listform" method="post">
        <table class="tb tb2 fixpadding" style="width: 1700px;" >
            ...
            <tr class="header">
                ...
                <th colspan="5" style="text-align:center;border-right:1px solid #A9A9A9;color: blue"><?php echo Yii::T('common', 'All platform old users') ?></th>
                <th colspan="5" style="text-align:center;border-right:1px solid #A9A9A9;color: blue"><?php echo Yii::T('common', 'All platform new users') ?></th>
                <th colspan="4" style="text-align:center;border-right:1px solid #A9A9A9;color: red"><?php echo Yii::T('common', 'All users') ?></th>
                <th colspan="4" style="text-align:center;border-right:1px solid #A9A9A9;color: red"><?php echo Yii::T('common', 'All platform old users') ?></th>
                <th colspan="4" style="text-align:center;border-right:1px solid #A9A9A9;color: red"><?php echo Yii::T('common', 'All platform new users') ?></th>
            </tr>
            <tr class="header">
