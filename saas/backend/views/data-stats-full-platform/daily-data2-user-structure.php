...
$this->showsubmenu(Yii::T('common', 'Daily borrowing data (loans - user structure)'));
?>
...
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get','action'=> Url::to(['data-stats-full-platform/daily-data2-user-structure']), 'options' => ['style' => 'margin-top:5px;']]); ?>
    <?php
