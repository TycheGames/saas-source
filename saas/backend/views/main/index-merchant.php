...
$messageUrl = Url::toRoute('message/message-list');
...
<p>hello，<em>{$phone}</em> [<a href="{$logoutUrl}" target="_top">quit</a>]</em> [<a href="{$resetRoleUrl}" target="_top">refresh</a>] <a href="{$chLanguage}">changeLanguage</a>   </p>
</div>
<div class="nav">
<ul id="topmenu">
