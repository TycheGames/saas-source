...
<table class="tb tb2 fixpadding">
	...
	<tr class="hover">
		...
		<td class="td24">
			<a href="<?php echo Url::to(['back-end-admin-user/change-pwd', 'id' => $value->id]); ?>"><?php echo Yii::T('common', 'change Password') ?></a>
			<?php if ($value->username != AdminUser::SUPER_USERNAME): ?>
			<a href="<?php echo Url::to(['back-end-admin-user/edit', 'id' => $value->id]); ?>"><?php echo Yii::T('common', 'edit') ?></a>
			<a onclick="return confirmMsg('Are you sure you want to delete it ?');" href="<?php echo Url::to(['back-end-admin-user/delete', 'id' => $value->id]); ?>"><?php echo Yii::T('common', 'del') ?></a>
			<?php endif; ?>
		</td>
	</tr>
	<?php endforeach; ?>
