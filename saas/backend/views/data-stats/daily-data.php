...
?>
<title><?php echo Yii::T('common', 'Daily borrowing data') ?></title>
    <style>
...
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get','action'=> Url::to(['data-stats/daily-data']), 'options' => ['style' => 'margin-top:5px;']]); ?>
    <?php
    ...
    <form name="listform" method="post">
        <table class="tb tb2 fixpadding">
            <tr class="header">
                ...
                <th colspan="3" style="color:blue;text-align: center;border-right:1px solid blue;"><?php echo Yii::T('common', 'New users') ?></th>
                <th colspan="3" style="color:red;text-align: center;border-right:1px solid red;"><?php echo Yii::T('common', 'Old users') ?></th>
            </tr>
            <tr class="header">
