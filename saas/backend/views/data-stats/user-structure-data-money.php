 ...
 */
$this->showsubmenu(Yii::T('common', 'User structure export money'), array(
));
?>
...
<?php $form = ActiveForm::begin(['id' => 'search_form', 'method' => 'get', 'action' =>  Url::to(['data-stats/user-structure-export-money']), 'options' => ['style' => 'margin-top:5px;']]); ?>
<?php
...
<form name="listform" method="post">
    <table class="tb tb2 fixpadding">
        ...
        <tr class="hover">
            ...
            <td class="td25"
                style="text-align:center;color:red"><?php echo isset($total_info['first_over_money_2']) ? $total_info['first_over_money_2'] : 0; ?></td>
            ...
            <td class="td25"
                style="text-align:center;color:blue"><?php echo isset($total_info['first_over_money_3']) ? $total_info['first_over_money_3'] : 0; ?></td>
