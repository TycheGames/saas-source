 ...
 */
$this->showsubmenu(Yii::T('common', 'User structure export num'), array(
    ));
?>
...
<?php $form = ActiveForm::begin(['id' => 'search_form', 'method' => 'get', 'action' =>  Url::to(['data-stats/user-structure-export-num']), 'options' => ['style' => 'margin-top:5px;']]); ?>
<?php
...
<form name="listform" method="post">
    <table class="tb tb2 fixpadding">
        ...
        <tr class="hover">
            ...
            <td class="td25"
                style="text-align:center;color:red"><?php echo isset($total_info['first_over_num_2']) ? $total_info['first_over_num_2'] : 0; ?></td>
            ...
            <td class="td25"
                style="text-align:center;color:blue"><?php echo isset($total_info['first_over_num_3']) ? $total_info['first_over_num_3'] : 0; ?></td>
