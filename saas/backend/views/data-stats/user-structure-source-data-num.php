 ...
 */
$this->showsubmenu(Yii::T('common', 'User structure source export num'), array(
    ));
?>
...
<?php $form = ActiveForm::begin(['id' => 'search_form', 'method' => 'get', 'action' =>  Url::to(['data-stats/user-structure-source-export-num']), 'options' => ['style' => 'margin-top:5px;']]); ?>
<?php
    echo Html::dropDownList('search_date', Html::encode(Yii::$app->getRequest()->get('search_date', '2')), array(1 => Yii::T('common', 'Loan date'), 2 => Yii::T('common', 'Repayment date')));
?>
...
<form name="listform" method="post">
    <table class="tb tb2 fixpadding">
        ...
        <tr class="hover">
            ...
            <td class="td25"><?php echo isset($total_info['first_over_num_0']) ? $total_info['first_over_num_0'] : 0; ?></td>
            <td class="td25" style="border-right:1px solid #A9A9A9;"><?php echo empty($total_info['expire_num_0']) ? '-' : sprintf("%0.2f", ($total_info['first_over_num_0'] / ($total_info['expire_num_0'])) * 100) . "%"; ?></td>
            ...
            <td class="td25"
                style="text-align:center;color:blue"><?php echo isset($total_info['first_over_num_1']) ? $total_info['first_over_num_1'] : 0; ?></td>
            <td class="td25" style="text-align:center;color:blue;border-right:1px solid blue;"><?php echo empty($total_info['expire_num_1']) ? '-' : sprintf("%0.2f", ($total_info['first_over_num_1'] / ($total_info['expire_num_1'])) * 100) . "%"; ?></td>
            ...
            <td class="td25"
                style="text-align:center;color:red"><?php echo isset($total_info['first_over_num_2']) ? $total_info['expire_num_2'] : 0; ?></td>
            <td class="td25" style="text-align:center;color:red;border-right:1px solid red;"><?php echo empty($total_info['expire_num_2']) ? '-' : sprintf("%0.2f", ($total_info['first_over_num_2'] / ($total_info['expire_num_2'])) * 100) . "%"; ?></td>

            <!-- 全老、本老 -->
            <td class="td25"
                style="text-align:center;color:blue"><?php echo isset($total_info['expire_num_3']) ? $total_info['expire_num_3'] : 0; ?></td>
            <td class="td25"
                style="text-align:center;color:blue"><?php echo isset($total_info['first_over_num_3']) ? $total_info['expire_num_3'] : 0; ?></td>
            <td class="td25" style="text-align:center;color:blue;border-right:1px solid blue;"><?php echo empty($total_info['expire_num_3']) ? '-' : sprintf("%0.2f", ($total_info['first_over_num_3'] / ($total_info['expire_num_3'])) * 100) . "%"; ?></td>

            <td class="td25"
                style="text-align:center;color:red"><?php echo isset($total_info['expire_num_4']) ? $total_info['expire_num_4'] : 0; ?></td>
            <td class="td25"
                style="text-align:center;color:red"><?php echo isset($total_info['first_over_num_4']) ? $total_info['expire_num_4'] : 0; ?></td>
            <td class="td25" style="text-align:center;color:red;border-right:1px solid red;"><?php echo empty($total_info['expire_num_4']) ? '-' : sprintf("%0.2f", ($total_info['first_over_num_4'] / ($total_info['expire_num_4'])) * 100) . "%"; ?></td>
        </tr>
        <?php foreach ($info as $key => $value): ?>
            <tr class="hover"
                ...
                <td class="td25">
                        <?php echo isset($value['first_over_num_0']) ? $value['first_over_num_0'] : 0; ?>
                </td>
                <td class="td25" style="border-right:1px solid #A9A9A9;"><?php echo empty($value['expire_num_0']) ? '-' : sprintf("%0.2f", ($value['first_over_num_0'] / $value['expire_num_0']) * 100) . "%"; ?></td>
                ...
                <td class="td25"
                    style="text-align:center;color:blue"><?php echo isset($value['first_over_num_1']) ? $value['first_over_num_1'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:blue;border-right:1px solid blue;"><?php echo empty($value['expire_num_1']) ? '-' : sprintf("%0.2f", ($value['first_over_num_1'] / $value['expire_num_1']) * 100) . "%"; ?></td>

                <!-- 全老、本新 -->
                <td class="td25"
                    style="text-align:center;color:red"><?php echo isset($value['expire_num_2']) ? $value['expire_num_2'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:red"><?php echo isset($value['first_over_num_2']) ? $value['first_over_num_2'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:red;border-right:1px solid red;"><?php echo empty($value['expire_num_2']) ? '-' : sprintf("%0.2f", ($value['first_over_num_2'] / $value['expire_num_2']) * 100) . "%"; ?></td>

                <!-- 全老、本老 -->
                <td class="td25"
                    style="text-align:center;color:blue"><?php echo isset($value['expire_num_3']) ? $value['expire_num_3'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:blue"><?php echo isset($value['first_over_num_3']) ? $value['first_over_num_3'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:blue;border-right:1px solid blue;"><?php echo empty($value['expire_num_3']) ? '-' : sprintf("%0.2f", ($value['first_over_num_3'] / $value['expire_num_3']) * 100) . "%"; ?></td>

                <td class="td25"
                    style="text-align:center;color:red"><?php echo isset($value['expire_num_4']) ? $value['expire_num_4'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:red"><?php echo isset($value['first_over_num_4']) ? $value['first_over_num_4'] : 0; ?></td>
                <td class="td25"
                    style="text-align:center;color:red;border-right:1px solid red;"><?php echo empty($value['expire_num_4']) ? '-' : sprintf("%0.2f", ($value['first_over_num_4'] / $value['expire_num_4']) * 100) . "%"; ?></td>
            </tr>
        <?php endforeach; ?>
