...
$this->showsubmenu('review list', array(
));
?>
...
<table class="tb tb2 fixpadding">
    ...
    <?php foreach ($data_list as $value): ?>
        <tr class="hover">
            ...
            <th><a href="javascript:;" onclick="callPhone(<?= Html::encode($value['phone']); ?>)"><?= Html::encode($value['phone']); ?></a></th>
            ...
            <th>
                <a href="<?= Url::to(['credit-audit/review', 'id' => CommonHelper::idEncryption($value['id'], 'order')]);?>"><?php echo Yii::T('common', 'Audit') ?></a>
            </th>
        </tr>
    <?php endforeach; ?>
</table>
...
<script>
    function callPhone(phone) {
        ...
        $.ajax({
            url: "<?= Url::toRoute(['credit-audit/call-phone', 't' => time()]); ?>",
            type: 'get',
            dataType: 'json',
            data: data,
            async:false,
