...
$this->shownav('creditAudit', 'menu_credit_nx_phone_data');
$this->showsubmenu('信审牛信拨打记录', array(
    ['信审牛信拨打记录',Url::toRoute('credit-audit/nx-phone-data'),1],
));
?>
...
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get', 'action'=>Url::to(['credit-audit/nx-phone-data']),'options' => ['style' => 'margin-top:5px;']]); ?>
信审员：<input type="text" value="<?php echo Html::encode(Yii::$app->getRequest()->get('username', '')); ?>" name="username" class="txt" style="width:120px;">&nbsp;
