...
$this->showsubmenu('', array(
    array('small team leader list ', Url::toRoute('user-collection/small-team-leader-list'), 0),
));
?>
<style>
    td.label {
...
<table class="tb tb2 fixpadding">
    ...
    <tr>
        <td class="label">deputy team collector：</td>
        <td>
            <?php echo $form->field($deputyModel, 'slave_admin_id')->dropDownList($teamCollectorList,['prompt' => '--NOT SET--']); ?>
        </td>
    </tr>
    <tr>
        <td></td>
