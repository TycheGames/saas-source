...
$this->showsubmenu('', array(
    ...
    array('Preliminary review', Url::toRoute('user-collection/audit-apply'), 1),
...
<?php $form = ActiveForm::begin(['method' => "get", 'action'=>Url::to(['user-collection/audit-apply']), 'options' => ['style' => 'margin-top: 10px;margin-bottom:10px;'] ]); ?>
    ...
    <table class="tb tb2 fixpadding">
        ...
        <?php foreach ($auditApply as $value): ?>
            <tr class="hover">
                ...
                <td>
                    <a href="<?php echo Html::encode(Url::to(['user-collection/audit', 'id' => $value['id'], 'status' => AbsenceApply::STATUS_YES, 'history_url' => $url])); ?>">pass</a>&nbsp;&nbsp;
                    <a href="<?php echo Html::encode(Url::to(['user-collection/audit', 'id' => $value['id'], 'status' => AbsenceApply::STATUS_NO, 'history_url' => $url])); ?>">no</a>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
