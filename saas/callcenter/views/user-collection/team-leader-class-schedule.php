...
$this->shownav('manage', 'menu_user_collection_begin','menu_team_user_class_schedule');
$this->showsubmenu('', array(
    array('Daily Work Plan (TL)', Url::toRoute('user-collection/team-leader-class-schedule'), 1),
));
...
<table class="tb tb2 fixpadding">
    <tr class="header">
        ...
        <th style="color: green">team name</th>
    ...
    <?php foreach ($list as $value): ?>
        <tr class="hover">
            ...
            <th <?php if($value['open_status'] == 0):?>style="color: red"<?php endif;?>><?php echo $value['team_name'];  ?></th>
...
<script type="text/javascript">
    ...
    var type = '';
    var flag = 0;
    var adminUserMasterSlaverRelation = null;
    function preView(id,date){
        ...
        $('.pop-box').show();
        $.ajax({
            url: '<?php echo Url::to(['user-collection/team-class-schedule-view']); ?>',
            ...
            success: function(res){
                if(res.code == 0){
                    ...
                    type = res.data['type'];
                    adminUserMasterSlaverRelation = res.data['adminUserMasterSlaverRelation'];
                    if(adminUserMasterSlaverRelation){
                        username += ' (deputy username: ' + adminUserMasterSlaverRelation.username + ')'
                    }
    ...
    function statusChange(){
        ...
        $.ajax({
            url: '<?php echo Url::to(['user-collection/team-class-schedule-edit']); ?>',
