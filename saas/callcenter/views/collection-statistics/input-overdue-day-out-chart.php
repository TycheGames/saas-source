...
$this->showsubmenu(Yii::T('common', 'Overdue days out of the reminder rate (by amount)'), array(
    array('list', Url::toRoute('collection-statistics/input-overdue-day-out'), 0),
    array('chart', Url::toRoute('collection-statistics/input-overdue-day-out-chart'), 1),
));
?>
...
<?php $form = ActiveForm::begin(['id' => 'search_form','method'=>'get', 'action'=>Url::to(['collection-statistics/input-overdue-day-out-chart']), 'options' => ['style' => 'margin-top:5px;']]); ?>
