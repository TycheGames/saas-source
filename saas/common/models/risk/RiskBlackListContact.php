...
/**
 * 黑名单-联系人
 * This is the model class for table "{{%risk_black_list_contact}}".
 * Class RiskBlackListContact
...
class RiskBlackListContact extends ActiveRecord {
    ...
    public static function tableName(){
        return '{{%risk_black_list_contact}}';
    }
