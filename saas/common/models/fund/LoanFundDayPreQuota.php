...
class LoanFundDayPreQuota extends \yii\db\ActiveRecord
{
    ...
    public function attributeHints() {
        return [
            ...
            'incr_amount'=>Yii::T('common', 'Unit is cents'),
            'decr_amount'=>Yii::T('common', 'Unit is cents'),
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'incr_amount' => Yii::T('common', 'Pre-increase quota'),
            'decr_amount' => Yii::T('common', 'Pre-reduction quota'),
